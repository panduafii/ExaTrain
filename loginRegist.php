                ...
                <div class="login-container">
                    ...
                    <div class="login">
                        ...
                        if (isset($_SESSION['error_message'])) {
                            echo '<div id="alertMessage" style="color: red;">' . $_SESSION['error_message'] . '</div>';
                        ...
                        <button class="admin-button" type="button" onclick="location.href='admin/adminPengguna.php'">I'm admin</button>
                    </div>
